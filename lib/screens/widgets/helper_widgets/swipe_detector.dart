  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onVerticalDragEnd: (endDetails) {
        ...
        double dx = 0;
        double dy = 0;
        if (updateVerticalDragDetails?.globalPosition != null &&
            startVerticalDragDetails?.globalPosition != null) {
          dx = updateVerticalDragDetails.globalPosition.dx -
              startVerticalDragDetails.globalPosition.dx;
          dy = updateVerticalDragDetails.globalPosition.dy -
      ...
      onHorizontalDragEnd: (endDetails) {
        ...
        double dx = 0;
        double dy = 0;
        if (updateHorizontalDragDetails?.globalPosition != null &&
            startHorizontalDragDetails?.globalPosition != null) {
          dx = updateHorizontalDragDetails.globalPosition.dx -
              startHorizontalDragDetails.globalPosition.dx;
          dy = updateHorizontalDragDetails.globalPosition.dy -
