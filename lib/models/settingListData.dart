...
class SettingsListData {
  ...
  static List<SettingsListData> userUnauthenticatedOptions = [
    SettingsListData(
      titleTxt: GeneralStrings.HELP_CENTER,
      isSelected: false,
      iconData: FontAwesomeIcons.infoCircle,
    ),
    SettingsListData(
      titleTxt: GeneralStrings.PRIVACY_POLICY,
      isSelected: false,
      iconData: FontAwesomeIcons.shieldAlt,
    ),
    SettingsListData(
      titleTxt: GeneralStrings.TERMS_AND_CONDITIONS,
      isSelected: false,
      iconData: FontAwesomeIcons.fileSignature,
    ),
  ];

  static List<SettingsListData> userAuthenticatedOptions = [
    SettingsListData(
      titleTxt: GeneralStrings.CHANGE_PASSWORD,
      isSelected: false,
      iconData: FontAwesomeIcons.lock,
    ),
    SettingsListData(
      titleTxt: GeneralStrings.MY_CART,
      isSelected: false,
    ...
    // ),
    SettingsListData(
      titleTxt: GeneralStrings.MY_ORDERS,
      isSelected: false,
    ...
    // ),
    SettingsListData(
      titleTxt: GeneralStrings.LOGOUT,
      isSelected: false,
